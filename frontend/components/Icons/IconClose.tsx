...
function IconClose() {
    return (
        <motion.svg
            ...
            <path d="M7.51477 7.51465L24.4853 24.4852" stroke="#B7B7B7" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M24.4854 7.51465L7.51479 24.4852" stroke="#B7B7B7" strokeWidth="1.5" strokeLinecap="round" />
        </motion.svg>
    );
}
